...
Itse poolaus tapahtuu niin, että liitetään kuhunkin reittiin tieto, millä gridin ruudulla se on, jonka jälkeen ryhmitellään kaikki reitit gridiruuduittain ja lasketaan niille keskiarvot. Tallennan taas kaikki tiedot niin, että ne on helppo lukea ja tarkistaa GIS:llä.
...
Lasketaan periodien välinen muutos havainnoille ja ennusteille ja näiden korrelaatiot.
...
(Koodissa olioiden nimissä on hämäävästi 'pa' mutta nämä ovat silti abu-aineistoa.)
...
```{r}
#valitaan D ja poolatut D arvot
#pa
...
#testataan onko merkitsev?? eroa
#poolattujen change pa ja abu v?lill?
t.test(res2$pool_pa_change,res2$pool_abu_change, paired=TRUE)
```

```{r}
#piirret??n sama kuvaaja, jossa nyt mukana my?s poolatut arvot
# Figure 1ABCDEF
...
# a)
plot(pa_B~pa_past,data=res2,xlim=c(-1,1),
...
# b)
plot(abu_B~abu_past,data=res2,xlim=c(-1,1),
     ylim=c(-1,1),cex.axis=0.8,xlab="Prediction accuracy (past)",
     ylab="Prediction accuracy (B)")
lines(Line$Line,Line$Line2,lty="dashed")
lines(Line$Line,Line$Line3,col="grey",lty="dashed")
...
# c)
plot(pa_D~pa_past,data=res2,xlim=c(-1,1),
     ylim=c(-1,1),cex.axis=0.8,xlab="Prediction accuracy (past)",
...
# d)
plot(abu_D~abu_past,data=res2,xlim=c(-1,1),
     ylim=c(-1,1),cex.axis=0.8,xlab="Prediction accuracy (past)",
     ylab="Prediction accuracy (D)")
lines(Line$Line,Line$Line2,lty="dashed")
lines(Line$Line,Line$Line3,col="grey",lty="dashed")
...
# e) 
plot(pool_pa_change~pa_past,data=res2,xlim=c(-1,1),
     ylim=c(-1,1),cex.axis=0.8,xlab="Prediction accuracy (past)",
...
# f)
plot(pool_abu_change~abu_past,data=res2,xlim=c(-1,1),
     ylim=c(-1,1),cex.axis=0.8,xlab="Prediction accuracy (past)",
     ylab="Prediction accuracy (change)")
lines(Line$Line,Line$Line2,lty="dashed")
lines(Line$Line,Line$Line3,col="grey",lty="dashed")
