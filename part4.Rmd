...
localDir = "."
PredictionDir = file.path(localDir, "predictions_99_constant")

paketit<-c("readr","tidyr","dplyr","plyr","magrittr","purrr","data.table","plotrix","jtools","sp","GISTools","rgdal","sf","spatialEco")
...
pm1p1=mpred1[period1,]  #t?ss? siis k?ytet??n m1, model1 eli kalibroinnissa k?ytetty aineistoa vain 2006 vuoteen asti
...
#lasketaan kullekin linjalle (jolla on k?yty kahdesti kummankin periodin aikana, yhteens? 592 kpl) keskiarvot periodeittain
...
for (i in 1:nsr){
  ...
  Ay1[i,] = colMeans(y1[take1,]) #Suomen vesilintujen NA:t s?ilyv?t laskuissa
  Ay2[i,] = colMeans(y2[take2,])
}

#lis?t??n kullekin linjalle koordinaatit
...
#tallennan, jotta voin tarkastella my?s kartalla GIS:ll? paremmin
...
#turha v?livaihe mutta helpottaa tarkastamista
Ay1<-read.csv("pa_obs_per1.csv",header=T,sep=",")
Ay2<-read.csv("pa_obs_per2.csv",header=T,sep=",")
Ap1<-read.csv("pa_pred_per1.csv",header=T,sep=",")
Ap2<-read.csv("pa_pred_per2.csv",header=T,sep=",")

#sitten itse poolaus
#luetaan sis??n linjat..
...
#ja gridi.
#gridi<- readOGR(dsn="C:/Users/U1701911/OneDrive - University of Helsinki/mallinnus/ennusteet/ennusteet_100/poolaus", layer="grid50km")
#gridi<- readOGR(dsn="C:/Users/Sirke Piirainen/OneDrive - University of Helsinki/mallinnus/ennusteet/ennusteet_100/poolaus", layer="grid50km")
gridi<- readOGR(dsn="C:/Users/U1701911/OneDrive - University of Helsinki/mallinnus/ennusteet/ennusteet_100/poolaus", layer="grid100km")

proj4string(gridi)
plot(gridi)

#liitet??n kuhunkin linjaan tieto, mill? gridin ruudulla se on
...
#lasketaan poolatulla aineistolla uudelleen ennustustarkkuus, tavalla D
#peruspoolaus

#luetaan aineisto takaisin sis??n
...
#lasketaan erotukset periodin 1 ja 2 v?lil?
#pa
#obs
...
#yhdistet??n tulokset, havainnot ja ennusteet samaan dataframeen
...
paKor %>%
  ...
  write.csv('pool_kor_change_pa_99_constant_100kmgrid.csv',row.names=F)
