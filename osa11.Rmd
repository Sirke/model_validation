...
Lasketaan ennustustarkkuus kun ennustetaan kunkin lajin esiintymistodenn?k?isyytt? yhten? ajanhetken? (periodi 2)  
...
Lasketaan ennustustarkkuudet my?s reittikohtaisesti, kullakin nelj?ll? tyylill? (A,B,C,D).   
Ensin A ja B:
...
Lasketaan ennustustarkkuus kun ennustetaan kunkin lajin esiintymistodenn?k?isyyden muutosta periodien 1 ja 2 v?lill?  
...
#### Selitt??k? leveysaste ennustustarkkuutta?
...
### Todelliset ja ennustetut muutokset esiintymistodenn?k?isyyksiss? periodien 1 ja 2 v?lill?

Tarkastellaan viel? absoluuttisia todellisia ja ennustettuja muutoksia esiintymistodenn?k?isyyksiss?. Ennusteet on tehty joko tyyliin C tai D, eli koko aineistoa tai osittaista aineistoa hy?dynt?m?ll?.
...
Lasketaan kaikki samat asiat abundance -aineistolla my?s.
...
My?s abu-aineistolla varsinkin muutoksen ennustaminen on vaikeaa.
...
My?s abu-aineistolla reittikohtaiset ennustustarkkuudet ovat hieman parempia.


#### Selitt??k? pituusaste ennustustarkkuutta?
...
#testataan selitt??k? latitude (y) ennustustarkkuutta (corD)
