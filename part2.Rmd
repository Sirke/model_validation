...
Testaan ensin rinnakkain, miten tulokset muuttuvat jos abu-aineistosta karsitaan pois muutamat havainnot, jotka perustuvat vain kolmeen tai neljään havaintoon. 

```{r}
res3=res
res3$abu_D[res$P_D<5]=NA
res3
```
