...
Jos minimihavaintorajana pidetään kymmentä, pohjansirkku ja pyy putoavat pois (muuttuvat NA:ksi). Tarkistan NA-havaintojen määrät.
...
Sekamalli näyttäisi olevan parempi. Tosin varoitusviesti sanoo, että mallit perustuvat eri havaintomääriin. Varoitus liittyy varmaan siihen, että Kaksi lajia on abundance-aineistossa ilman C ja D arvoja.
...
Vaihtoehtoiset mallit eivät näytä toimivan. Enkä tiedä onko niissä mitään järkeä.
...
Eli ennustustarkkuuteen vaikuttavat metodin ja aineiston yhdistelmä. Huonoimmat ennustustarkkuudet saa abu-aineistolla ja metodilla D.
...
Pa ja method-interaktio merkitsevä.
...
Kuvaaja, jossa keskiarvot ja luottamusvälit:
